...
class Player(BasePlayer):
    ...
    ROI = models.FloatField(initial=None)
    ROI2 = models.FloatField(initial=None)
    ROI3 = models.FloatField(initial=None)
    US2 = models.FloatField(initial=100000)
    ETH2 = models.FloatField(initial=200)
    Assent_day1 = models.FloatField(initial=None)
    Assent_day10 = models.FloatField(initial=None)
